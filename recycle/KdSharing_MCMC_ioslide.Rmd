...
$$
- 具有马尔科夫性的随机过程为**马尔科夫过程**。
- 时间和状态都是离散的马尔科夫过程为**马尔科夫链**也作马氏链。
...
当P_{ij}(m, m + n)只与$i,j,n$有关时，又可记为$P_{ij}(n)$,此时称此转移概率具有平稳性，并且称链具有齐次性。$P(n)$则称为$n$步转移概率矩阵。
...
由此推出：
$$
P(n) = P^1P(n-1)=P(1)P(1)P(n-2)=\dots=P(1)^n
$$
